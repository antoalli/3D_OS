...
Code from: https://github.com/Strawberry-Eat-Mango/PCT_Pytorch
Re-implemented sth by Anto
"""
...
class PCT(nn.Module):
    def __init__(self, emb_dims=1024):
        ...
        self.conv_fuse = nn.Sequential(
            nn.Conv1d(1280, self.emb_dims, kernel_size=1, bias=False),
    ...
    def forward(self, xyz):
        ...
        # sample_and_group
        # xyz: input points position data, [B, N, 3]
        # points: input points data, [B, N, D] (referred to as 'x')
